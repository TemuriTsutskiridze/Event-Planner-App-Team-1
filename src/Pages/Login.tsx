  ...
  return (
    <main className="flex flex-col items-center">
      ...
      <section className="flex flex-col gap-4 mt-[46px]">
        ...
        >
          ...
          <input
            id="password"
            type="password"
            className="outline-none appearance-none w-[280px] h-[19px] pl-1 bg-transparent text-2xl text-[#000] font-400 leading-[19px] tracking-[6px]"
          />
          {!isHide ? (
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-eye-slash absolute right-[15px] top-1/2 transform -translate-y-1/2"
              viewBox="0 0 16 16"
            >
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-eye absolute right-[16px] top-1/2 transform -translate-y-1/2"
              viewBox="0 0 16 16"
            >
      ...
      <section className="flex flex-col gap-4 mt-40 mb-[50px]">
        ...
        <button className="w-[343px] h-[50px] rounded-[10px] bg-[#fff] border-[2px] border-solid border-input flex items-center justify-center text-base text-[#274d76] font-normal leading-[19px]">
          Create new account
        </button>
      </section>
    </main>
