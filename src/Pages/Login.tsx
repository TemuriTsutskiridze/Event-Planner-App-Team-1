  ...
  return (
    <main className="flex flex-col items-center">
      ...
      <form onSubmit={handleSubmit(handleLogin)}>
        <section className="flex flex-col justify-between h-[126px] mt-[46px] md:mt-[50px]">
          <div className="flex flex-col">
            ...
            {errors.email ? (
              <span
                className={`${
                  errors && errors.email ? "text-[#f22e2e]" : ""
                } text-sm font-[400] leading-[17px] ml-2 mb-1`}
              >
          ...
          <div className="flex flex-col">
            ...
            {errors.password ? (
              <span
                className={`${
                  errors && errors.password ? "text-[#f22e2e]" : ""
                } text-sm font-[400] leading-[17px] ml-2`}
              >
